...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // Si el parámetro 'view' es 'catalogoProductos', cargar automáticamente la página
    if (view === "catalogoProductos") {
      cargarPagina('jsp/catalagoProductos.jsp');

      // Expandir el menú de "Punto de Venta" automáticamente
      const puntoVenta = document.getElementById("puntoVenta");
      if (puntoVenta) {
        puntoVenta.classList.add("show"); // Bootstrap usa "show" para expandir
        const link = document.querySelector("[data-bs-target='#puntoVenta']");
        if (link) link.setAttribute("aria-expanded", "true"); // Marcar como expandido
      }
    }
  });
</script>
