      ...
      <nav aria-label="Page navigation">
        ...
        <ul class="pagination mb-0" id="pagination">
          ...
          <li class="page-item <% if (i == pagina) { %>active<% } %>">
            <a class="page-link" aria-label="Actual" href="menu.jsp?view=usuarios&page=<%= i %>"><%= i %></a>
          </li>
          <% } %>

          <li class="page-item <% if (pagina == totalPages) { %>disabled<% } %>">
            <a class="page-link" aria-label="Siguiente" href="menu.jsp?view=usuarios&page=<%= pagina + 1 %>">Siguiente</a>
          </li>
        </ul>
      </nav>
    </div>
