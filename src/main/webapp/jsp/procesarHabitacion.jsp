      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-12 d-flex align-items-center gap-2">
            ...
            <select class="form-select w-75" id="busquedaCliente" aria-label="Default select example">
        ...
        <div class="row">
          ...
          <div class="col-md-6 mt-2">
            <div class="d-flex justify-content-between align-items-center">
              ...
              <div class="d-flex">
                <div class="form-check me-3">
                  <input class="form-check-input" type="radio" name="descuentoTipo" id="descuentoPorcentual">
                  <label class="form-check-label" for="descuentoPorcentual">%</label>
                </div>

                <div class="form-check">
                  <input class="form-check-input" type="radio" name="descuentoTipo" id="descuentoMonetario">
            ...
            <div class="input-group mt-2">
              <input type="text" id="descuento" name="descuento" class="form-control form-control-lg bg-light fs-6">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="#">
            ...
            <div class="row">
              <div class="col-md-6 mt-2">
                <label for="tipoDocumentoModal" class="form-label"><strong>Tipo de Documento:</strong></label>
                <select class="form-select" id="tipoDocumentoModal" aria-label="Default select example" required>
                  <option selected>Buscar Cliente</option>
